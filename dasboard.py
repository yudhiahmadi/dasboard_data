...
with tab1:
    ...
    st.subheader("Pendapatan dari Berbagai Kota")
    ...
    st.write('Berdasarkan analisis data yang diperoleh, penjualan meningkat seiring bertambahnya waktu, kota SP sangat suka dengan produk perusahaan, dan pendapatan lebih tinggi dari freight cost yang dikeluarkan. Saya merekomendasikan untuk:')
    st.write('1. Jika kita ingin membuka cabang maka kita perlu, Membuat Riset clusterisasi ke kota yang mirip karakteristiknya dengan Kota SP. Harapannya dengan karakteristik kota yang mirip maka kebutuhan penduduknya juga mirip sehingga jika disana tidak ada perusahaan kompetitor maka kita akan menjadi top of mind penyedia kebutuhan produk di kota tersebut.')
    st.write('2. Memperbaiki produk yang buruk yang sudah dipasarkan di kota target perusahaan kita. Untuk itu kita perlu melakukan pengolahan ke kategori apa produk yang buruk itu dengan melihat rating score kepuasan pelanggan, dan bagaimana pelanggan menyukai produk kita. (Jawabannya ada di penjelasan selanjutnya)')
...
with tab4:
    ...
    st.subheader("Pengiriman Perkota")
